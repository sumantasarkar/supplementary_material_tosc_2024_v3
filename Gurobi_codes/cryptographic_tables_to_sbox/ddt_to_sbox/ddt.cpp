    ...
    try {
        ...
        for(int row = 0 ; row < n-1; row++){
            ...
            for(j = 0 ; j < n-1 ; j++){
                ...
                //model.addConstr(temp == S3_ddt[row+1][j+1]/2);
                model.addConstr(temp == inv4_ddt[row+1][j+1]/2);
                //model.addConstr(temp == inv5_ddt[row+1][j+1]/2);
                //model.addConstr(temp == present_ddt[row+1][j+1]/2);
                //model.addConstr(temp == gift_ddt[row+1][j+1]/2);
                //model.addConstr(temp == skinny4_ddt[row+1][j+1]/2);
                //model.addConstr(temp == keccak_ddt[row+1][j+1]/2);
                //model.addConstr(temp == ascon_ddt[row+1][j+1]/2);
            }
