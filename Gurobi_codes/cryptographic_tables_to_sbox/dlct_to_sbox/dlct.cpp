        ...
        */
        ...
        for(int row = 0 ; row < n-1; row++){
            ...
            for(int la = 0; la < n-1; la++){
                ...
                //model.addConstr(temp == (inv3_act[row+1][la+1]/2  + n/2)/2);
                //model.addConstr(temp == (inv4_act[row+1][la+1]/2  + n/2)/2);
                //model.addConstr(temp == (inv4_act[row+1][la+1]/2  + n/2)/2);
                model.addConstr(temp == (serpent_dlct[row+1][la+1]  + n/2)/2);
                //model.addConstr(temp == (serpent_act[row+1][la+1]/2  + n/2)/2);
                //model.addConstr(temp == (present_act[row+1][la+1]/2  + n/2)/2);
                //model.addConstr(temp == (gift_act[row+1][la+1]/2  + n/2)/2);
                //model.addConstr(temp == (skinny4_act[row+1][la+1]/2  + n/2)/2);
                //model.addConstr(temp == (ascon_act[row+1][la+1]/2  + n/2)/2);
                //model.addConstr(temp == (keccak_act[row+1][la+1]/2  + n/2)/2);
