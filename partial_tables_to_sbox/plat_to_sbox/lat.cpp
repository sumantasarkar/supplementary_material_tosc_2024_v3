...
int lat_model(int threadNumber, int n, int rows);
int lat_model(int threadNumber, int n, int rows) {
    int i, j;
    try {
...
int lat_sbox(int size_sbox, int threadNumber, int rows) {
    lat_model(threadNumber, size_sbox, rows);
    return 0;
 }
